...
static int csi_enc_setup(cam_data *cam)
{
	...
	pr_err("******SENSOR PROTOCOL IPU_CSI ******\n");
	pr_err("USING: %d\n",sensor_protocol);
	...
	pr_err("IPU%d_CSI%d width=%d height=%d pixelformat=%d\n", cam->ipu_id,cam->csi,cam->v2f.fmt.pix.width,cam->v2f.fmt.pix.height,cam->v2f.fmt.pix.pixelformat);

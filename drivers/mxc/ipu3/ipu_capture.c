	...
	uint32_t pixel_fmt, ipu_csi_signal_cfg_t cfg_param)
{
	...
	pr_err("******Start: ipu_csi_init_interface\n");
	...
	case IPU_PIX_FMT_YUYV:
		...
		pr_err("ipu_csi_init_interface: pixel_fmt = CSI_SENS_CONF_DATA_FMT_YUV422_YUYV\n");
		break;
	case IPU_PIX_FMT_UYVY:
		cfg_param.data_fmt = CSI_SENS_CONF_DATA_FMT_YUV422_UYVY;
		pr_err("ipu_csi_init_interface: pixel_fmt = CSI_SENS_CONF_DATA_FMT_YUV422_UYVY\n");
		break;
	case IPU_PIX_FMT_RGB24:
	case IPU_PIX_FMT_BGR24:
		cfg_param.data_fmt = CSI_SENS_CONF_DATA_FMT_RGB_YUV444;
		pr_err("ipu_csi_init_interface: pixel_fmt = CSI_SENS_CONF_DATA_FMT_RGB_YUV444\n");
		break;
	case IPU_PIX_FMT_GENERIC:
	case IPU_PIX_FMT_GENERIC_16:
		cfg_param.data_fmt = CSI_SENS_CONF_DATA_FMT_BAYER;
		pr_err("ipu_csi_init_interface: pixel_fmt = CSI_SENS_CONF_DATA_FMT_BAYER\n");
		break;
	case IPU_PIX_FMT_RGB565:
		cfg_param.data_fmt = CSI_SENS_CONF_DATA_FMT_RGB565;
		pr_err("ipu_csi_init_interface: pixel_fmt = CSI_SENS_CONF_DATA_FMT_RGB565\n");
		break;
	case IPU_PIX_FMT_RGB555:
		cfg_param.data_fmt = CSI_SENS_CONF_DATA_FMT_RGB555;
		pr_err("ipu_csi_init_interface: pixel_fmt = CSI_SENS_CONF_DATA_FMT_RGB555\n");
		break;
	default:
		pr_err("ipu_csi_init_interface: pixel_fmt = UNKNOWN\n");
		return -EINVAL;
	}
